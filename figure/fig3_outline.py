	...
	for stra_cluster in range(4): 
		for dup in range(num_dup): 
			for n in range(5,6):  
				...
				if os.path.exists('../data/data_fig3_dots_outline/%s_%s_%s_%s.txt'%(dup,n,b,stra_cluster)):
					data=np.loadtxt('/data/data_fig3_dots_outline/%s_%s_%s_%s.txt'%(dup,n,b,stra_cluster))						
...
#		"growthe rate lambda"
	...
	plt.show()
#	fig.savefig('./fig3_outline_dots_b%s_c%s_dup20.pdf'%(b,c), bbox_inches = 'tight')   # save figures
